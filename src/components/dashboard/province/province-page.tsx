...
export function ProvincePage(): React.JSX.Element {
    ...
    const [rows, setRows] = React.useState<province[]>([]);
    ...
    const fetchprovinceData = async () => {
        ...
        fetch(`${baseUrl}/api/province/paginate?page=${page + 1}&limit=${rowsPerPage}&search=${search}`,
            {
                method: 'GET',
                headers: {
    ...
    const handleEditprovince = (id: number) => {
        setprovinceID(id)
        handleOpen()
    }
    ...
    return (
        <>
            <ProvinceModalForm open={open} handleClose={handleModalClose} provinceID={provinceID} fetchprovinceData={fetchprovinceData} />
            <Stack direction="row" spacing={3}>
                <Stack spacing={1} sx={{ flex: '1 1 auto' }}>
                    ...
                    <Stack direction="row" spacing={1} sx={{ alignItems: 'center' }}>
                        ...
                        />
                        <Button color="inherit" startIcon={<Refresh />} sx={{ bgcolor: '#f6f9fc' }} onClick={fetchprovinceData}>
                            refresh
                        </Button>
                    </Stack>
                </Stack>
                                ...
                                return (
                                    <TableRow hover key={row.id}>
                                        ...
                                        <TableCell>
                                            ...
                                            <IconButton color='error' onClick={() => handleDeleteprovince(row.id)}>
                                                <Delete />
                                            </IconButton>
                                        </TableCell>
                                    </TableRow>
