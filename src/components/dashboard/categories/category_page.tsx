...
export function CategoryPage(): React.JSX.Element {
  ...
  const fetchcategoryData = async () => {
    ...
    fetch(`${baseUrl}/api/category?page=${page + 1}&limit=${rowsPerPage}&search=${search}`,
      {
        method: 'GET',
        headers: {
  ...
  return (
    <>
      <CategoryModalForm open={open} handleClose={handleModalClose} categoryID={categoryID} fetchcategoryData={fetchcategoryData} />
